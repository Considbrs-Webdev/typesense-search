...
- A new "Typesense search" top-level admin menu (General, Pinned results, Synonymer),
  replacing the previous pages scattered under WordPress's Settings menu.
- Synonymer: manage Typesense synonym groups (e.g. "lekplatser, playground, amusement
  park") from the WordPress admin, with an explicit "Sync to Typesense" action.
- A stemming toggle in General settings that matches word variations (e.g. "running"
