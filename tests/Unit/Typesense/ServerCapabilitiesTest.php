...
class ServerCapabilitiesTest extends TestCase
{
    ...
    {
        $adminApi = Mockery::mock(AdminApi::class)->shouldReceive('contextKey')->andReturn('test')->byDefault()->getMock();
    ...
    {
        $adminApi1 = Mockery::mock(AdminApi::class)->shouldReceive('contextKey')->andReturn('test')->byDefault()->getMock();
        $adminApi1->shouldReceive('getServerVersion')->once()->andReturn('30.0.0');

        $adminApi2 = Mockery::mock(AdminApi::class)->shouldReceive('contextKey')->andReturn('test')->byDefault()->getMock();
